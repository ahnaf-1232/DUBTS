...
class BusTrackerController {
  ...
  Future<bool> startTrackingBus(String busId) async {
    return await _locationService.startTrackingBus(busId);
  }
  ...
  Future<double> calculateDistanceToBus(String busId) async {
    try {
      ...
      final busLocation = BusLocationModel.fromMap(
        busLocationSnapshot.docs.first.data()
      );
  ...
  Future<void> notifyWhenBusApproaching(String busId, String busName, double thresholdDistance) async {
